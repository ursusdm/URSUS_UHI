...
# #####Load Shape for image cropping######

#shpFile <- paste ("../data/SHAPEFILES/",cityName,"/",tolower(cityName),
#                  ".shx", sep="")
#shape  <- readOGR(shpFile)
#################################################

# Set lat,lng array of coordinates for city cropping
...
cord.UTM <- spTransform(coords, CRS("+proj=utm +zone=29 +datum=WGS84 +units=m +no_defs"))
